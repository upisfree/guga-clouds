...
import { jitter, didCameraMove } from "./TAAUtils"
import taa from "./shader/taa.frag.glsl?raw"

// хз почему оно не импортируется как фрагментный шейдер, мб пробел невидимый лишний какой-то
const vertexShader = `
varying vec2 vUv;
